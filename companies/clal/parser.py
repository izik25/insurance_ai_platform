...
class ClalParser(BaseParser):
    """Extracts embedded PDF text via PyMuPDF.

    Not actually needed to identify a Clal document - the appendix number
    comes from the search-API metadata (see downloader.py) - but
