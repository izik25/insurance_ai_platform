"""Phoenix PDF text parsing (no OCR)."""
...
class PhoenixParser(BaseParser):
    ...
    Not actually needed to identify a Phoenix document — the appendix
    number comes from the search-results metadata (see downloader.py) —
    but implemented for future full-text search / RAG use.
    """
