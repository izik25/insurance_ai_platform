...
from api.schemas import DocumentOut, ExtractionOut, MatchDocumentSummary, MatchOut, PolicyTableOut
...
def list_matches(status: str | None = Query(default=None)) -> list[MatchOut]:
    with session_scope() as session:
